...
//   const Watch({super.key, required this.profiles});
...
//                           items: Dummy.pompom[index].mediaUrls.map((url) {
//                             return Container(
...
//                             autoPlay: Dummy.pompom[index].mediaUrls.isEmpty ||
//                                     Dummy.pompom[index].mediaUrls.length == 1
//                                 ? false
//                                 : true,
...
//                               children: Dummy.pompom[index].mediaUrls
//                                   .asMap()
//                                   .entries
//                                   .map((entry) {
...
//                                     const Gap(15),
//                                     Text(
//                                       Dummy.pompom[index].age.toString(),
//                                       style: theme.textTheme.titleLarge
//                                           ?.copyWith(
//                                               color: Colors.white,
...
//                                             children: [
//                                               Text(
//                                                 'Studied in ${Dummy.pompom[index].university}',
...
//                                         Expanded(
//                                           child: Text(
//                                             '${Dummy.pompom[index].distanceInKilo} kilometer away',
//                                             overflow: TextOverflow.ellipsis,
//                                             style: theme.textTheme.bodySmall
//                                                 ?.copyWith(color: Colors.white),
//                                           ),
...
//                                             Dummy.pompom[index].profileImage),
//                                             fit: BoxFit.cover,
//                                       ),
//                                     ),
//                                   ),
