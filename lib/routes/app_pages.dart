...
import 'package:dating_app/presentation/pages/profile_edit.dart';
...
class AppPages {
  static final routes = GoRouter(
    ...
    GoRoute(
      path: Routes.PROFILE_EDIT_ROUTE.path,
      name: Routes.PROFILE_EDIT_ROUTE.name,
      pageBuilder: (context, state) => const MaterialPage(child: ProfileEdit()),
    ),
    ShellRoute(
